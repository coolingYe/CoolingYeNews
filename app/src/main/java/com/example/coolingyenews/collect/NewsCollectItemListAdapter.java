...
public class NewsCollectItemListAdapter extends BaseQuickAdapter<News,BaseViewHolder>{
    private View viewDialog;
    private Dialog bottomDialog;
    private List<News> data;
    public NewsCollectItemListAdapter(@Nullable List<News> data) {
        ...
        if(fragmentNewsCollectItemBinding!=null){
            ...
            fragmentNewsCollectItemBinding.ivMore.setOnClickListener(v -> {
                ...
                textView.setOnClickListener(v1 -> {
                    delNewsCollect(new HttpURL().HTTP_COLLECT_ADD_OR_DEL_URL("delCollectionNews", UserClass.getUid(), news.getNid()),baseViewHolder.getPosition());
                });
