...
public class VideoCollectItemListAdapter extends BaseQuickAdapter<Video,BaseViewHolder>{
    private View viewDialog;
    private Dialog bottomDialog;
    private List<Video> data;
    public VideoCollectItemListAdapter(@Nullable List<Video> data) {
        ...
        if(binding!=null){
            ...
            binding.ivMore.setOnClickListener(v -> {
                ...
                textView.setOnClickListener(v1 -> {
                    delNewsCollect(new HttpURL().HTTP_VIDEO_COLLECT_ADD_OR_DEL_URL("delCollectionVideo", UserClass.getUid(), video.getVid()),baseViewHolder.getPosition());
                });
