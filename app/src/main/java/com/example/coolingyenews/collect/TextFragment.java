...
public class TextFragment extends Fragment {
    ...
    private NewsCollectItemListAdapter newsCollectItemListAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        getNewsBySave(HttpURL.HTTP_NEWS_COLLECT_URL + mParam1);
                ...
                .execute(new SimpleCallBack<String>() {
                    ...
                    public void onSuccess(String s) {
                        if (s != null) {
                            ...
                            newsCollectItemListAdapter = new NewsCollectItemListAdapter(list);
                            binding.newsItemList.setAdapter(newsCollectItemListAdapter);
                        }
                    }
                });
    }
