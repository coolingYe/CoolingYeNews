...
//        }
    ...
    private void initFragment() {
        ...
        fragments.add(TextFragment.newInstance(String.valueOf(UserClass.getUid())));
        fragments.add(VFragment.newInstance(String.valueOf(UserClass.getUid())));
